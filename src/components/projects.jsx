    ...
    <div align='center'>
      ...
      <div style={{width:'85%', maxWidth:'650px', margin:'0 0 25px 0'}} align='center'>
          ...
          <Card style={{margin:'25px 0 25px 0'}}>
            ...
            <Card.Link href='https://github.com/TheRealDeathEye/starGenerator.git'><Card.Img src='imgs/starLogo.png' style={{height:'200px', objectFit: 'contain', background:'#000000', padding:'15px'}} /></Card.Link>
            <Card.Body style={{background:'#c7c4c3'}}>
