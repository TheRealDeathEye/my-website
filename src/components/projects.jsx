    ...
    <div align='center'>
      ...
      <div style={{width:'85%', maxWidth:'650px', margin:'0 0 25px 0'}} align='center'>
          <Card style={{margin:'25px 0 25px 0'}}>
            <Card.Header style={{fontSize: "1.6em", backgroundColor:'#212529', color:'white'}}  className="text-center">SnapAlgo</Card.Header>
            <Card.Link href='#'><Card.Img src='imgs/algologo.png' style={{height:'200px', objectFit: 'contain', background:'#c7c4c3', padding:'15px'}} /></Card.Link>
            <Card.Body style={{background:'#c7c4c3'}}>
              <p>An application that allows you to easily manage your Algorand tokens by connecting to MetaMask Snaps.</p>
            </Card.Body>
          </Card>
          <Card style={{margin:'25px 0 25px 0'}}>
